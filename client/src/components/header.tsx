...
const navigation = [
  ...
  { 
    ...
    submenu: [
      { name: "Bed Linen & Furnishing", href: "/products?category=home&subcategory=bed-linen", isCategory: true },
      { name: "Bed Runners", href: "/products?category=home&subcategory=bed-runners" },
      { name: "Mattress Protectors", href: "/products?category=home&subcategory=mattress-protectors" },
      { name: "Bedsheets", href: "/products?category=home&subcategory=bedsheets" },
      { name: "Bedding Sets", href: "/products?category=home&subcategory=bedding-sets" },
      { name: "Blankets, Quilts & Dohars", href: "/products?category=home&subcategory=blankets" },
      { name: "Pillows & Pillow Covers", href: "/products?category=home&subcategory=pillows" },
      { name: "Bed Covers", href: "/products?category=home&subcategory=bed-covers" },
      { name: "Diwan Sets", href: "/products?category=home&subcategory=diwan-sets" },
      { name: "Chair Pads & Covers", href: "/products?category=home&subcategory=chair-covers" },
      { name: "Sofa Covers", href: "/products?category=home&subcategory=sofa-covers" },
      { name: "Flooring", href: "/products?category=home&subcategory=flooring", isCategory: true },
      { name: "Floor Runners", href: "/products?category=home&subcategory=floor-runners" },
      { name: "Carpets", href: "/products?category=home&subcategory=carpets" },
      { name: "Floor Mats & Dhurries", href: "/products?category=home&subcategory=floor-mats" },
      { name: "Door Mats", href: "/products?category=home&subcategory=door-mats" },
      { name: "Bath", href: "/products?category=home&subcategory=bath", isCategory: true },
      { name: "Bath Towels", href: "/products?category=home&subcategory=bath-towels" },
      { name: "Hand & Face Towels", href: "/products?category=home&subcategory=hand-towels" },
      { name: "Beach Towels", href: "/products?category=home&subcategory=beach-towels" },
      { name: "Towels Set", href: "/products?category=home&subcategory=towel-sets" },
      { name: "Bath Rugs", href: "/products?category=home&subcategory=bath-rugs" },
      { name: "Bath Robes", href: "/products?category=home&subcategory=bath-robes" },
      { name: "Bathroom Accessories", href: "/products?category=home&subcategory=bathroom-accessories" },
      { name: "Shower Curtains", href: "/products?category=home&subcategory=shower-curtains" },
      { name: "Lamps & Lighting", href: "/products?category=home&subcategory=lighting", isCategory: true },
      { name: "Floor Lamps", href: "/products?category=home&subcategory=floor-lamps" },
      { name: "Ceiling Lamps", href: "/products?category=home&subcategory=ceiling-lamps" },
      { name: "Table Lamps", href: "/products?category=home&subcategory=table-lamps" },
      { name: "Wall Lamps", href: "/products?category=home&subcategory=wall-lamps" },
      { name: "Outdoor Lamps", href: "/products?category=home&subcategory=outdoor-lamps" },
      { name: "String Lights", href: "/products?category=home&subcategory=string-lights" },
      { name: "Home Décor", href: "/products?category=home&subcategory=decor", isCategory: true },
      { name: "Plants & Planters", href: "/products?category=home&subcategory=plants" },
      { name: "Aromas & Candles", href: "/products?category=home&subcategory=candles" },
      { name: "Clocks", href: "/products?category=home&subcategory=clocks" },
      { name: "Mirrors", href: "/products?category=home&subcategory=mirrors" },
      { name: "Wall Décor", href: "/products?category=home&subcategory=wall-decor" },
      { name: "Festive Decor", href: "/products?category=home&subcategory=festive-decor" },
      { name: "Pooja Essentials", href: "/products?category=home&subcategory=pooja" },
      { name: "Wall Shelves", href: "/products?category=home&subcategory=wall-shelves" },
      { name: "Fountains", href: "/products?category=home&subcategory=fountains" },
      { name: "Showpieces & Vases", href: "/products?category=home&subcategory=showpieces" },
      { name: "Ottoman", href: "/products?category=home&subcategory=ottoman" },
      { name: "Cushions & Cushion Covers", href: "/products?category=home&subcategory=cushions" },
      ...
      { name: "Home Gift Sets", href: "/products?category=home&subcategory=gift-sets" },
      { name: "Kitchen & Table", href: "/products?category=home&subcategory=kitchen", isCategory: true },
      { name: "Table Runners", href: "/products?category=home&subcategory=table-runners" },
      { name: "Dinnerware & Serveware", href: "/products?category=home&subcategory=dinnerware" },
      { name: "Cups and Mugs", href: "/products?category=home&subcategory=cups-mugs" },
      { name: "Bakeware & Cookware", href: "/products?category=home&subcategory=cookware" },
      { name: "Kitchen Storage & Tools", href: "/products?category=home&subcategory=kitchen-storage" },
      { name: "Bar & Drinkware", href: "/products?category=home&subcategory=barware" },
      { name: "Table Covers & Furnishings", href: "/products?category=home&subcategory=table-covers" },
      { name: "Storage", href: "/products?category=home&subcategory=storage", isCategory: true },
      { name: "Bins", href: "/products?category=home&subcategory=bins" },
      { name: "Hangers", href: "/products?category=home&subcategory=hangers" },
      { name: "Organisers", href: "/products?category=home&subcategory=organisers" },
      { name: "Hooks & Holders", href: "/products?category=home&subcategory=hooks" },
      { name: "Laundry Bags", href: "/products?category=home&subcategory=laundry-bags" },
    ]
  },
  { 
    name: "Beauty", 
    ...
    submenu: [
      { name: "Makeup", href: "/products?category=beauty&subcategory=makeup", isCategory: true },
      { name: "Lipstick", href: "/products?category=beauty&subcategory=lipstick" },
      { name: "Lip Gloss", href: "/products?category=beauty&subcategory=lip-gloss" },
      { name: "Lip Liner", href: "/products?category=beauty&subcategory=lip-liner" },
      { name: "Mascara", href: "/products?category=beauty&subcategory=mascara" },
      { name: "Eyeliner", href: "/products?category=beauty&subcategory=eyeliner" },
      { name: "Kajal", href: "/products?category=beauty&subcategory=kajal" },
      { name: "Eyeshadow", href: "/products?category=beauty&subcategory=eyeshadow" },
      { name: "Foundation", href: "/products?category=beauty&subcategory=foundation" },
      { name: "Primer", href: "/products?category=beauty&subcategory=primer" },
      { name: "Concealer", href: "/products?category=beauty&subcategory=concealer" },
      { name: "Compact", href: "/products?category=beauty&subcategory=compact" },
      { name: "Nail Polish", href: "/products?category=beauty&subcategory=nail-polish" },
      { name: "Skincare, Bath & Body", href: "/products?category=beauty&subcategory=skincare", isCategory: true },
      { name: "Face Moisturiser", href: "/products?category=beauty&subcategory=moisturiser" },
      { name: "Cleanser", href: "/products?category=beauty&subcategory=cleanser" },
      { name: "Masks & Peel", href: "/products?category=beauty&subcategory=masks" },
      { name: "Sunscreen", href: "/products?category=beauty&subcategory=sunscreen" },
      { name: "Serum", href: "/products?category=beauty&subcategory=serum" },
      { name: "Face Wash", href: "/products?category=beauty&subcategory=face-wash" },
      { name: "Eye Cream", href: "/products?category=beauty&subcategory=eye-cream" },
      { name: "Lip Balm", href: "/products?category=beauty&subcategory=lip-balm" },
      { name: "Body Lotion", href: "/products?category=beauty&subcategory=body-lotion" },
      { name: "Body Wash", href: "/products?category=beauty&subcategory=body-wash" },
      { name: "Body Scrub", href: "/products?category=beauty&subcategory=body-scrub" },
      { name: "Hand Cream", href: "/products?category=beauty&subcategory=hand-cream" },
      { name: "Baby Care", href: "/products?category=beauty&subcategory=baby-care" },
      { name: "Haircare", href: "/products?category=beauty&subcategory=haircare", isCategory: true },
      { name: "Shampoo", href: "/products?category=beauty&subcategory=shampoo" },
      { name: "Conditioner", href: "/products?category=beauty&subcategory=conditioner" },
      { name: "Hair Cream", href: "/products?category=beauty&subcategory=hair-cream" },
      { name: "Hair Oil", href: "/products?category=beauty&subcategory=hair-oil" },
      { name: "Hair Gel", href: "/products?category=beauty&subcategory=hair-gel" },
      { name: "Hair Color", href: "/products?category=beauty&subcategory=hair-color" },
      { name: "Hair Serum", href: "/products?category=beauty&subcategory=hair-serum" },
      { name: "Hair Accessory", href: "/products?category=beauty&subcategory=hair-accessories" },
      { name: "Fragrances", href: "/products?category=beauty&subcategory=fragrances", isCategory: true },
      { name: "Perfume", href: "/products?category=beauty&subcategory=perfume" },
      { name: "Deodorant", href: "/products?category=beauty&subcategory=deodorant" },
      { name: "Body Mist", href: "/products?category=beauty&subcategory=body-mist" },
      { name: "Appliances", href: "/products?category=beauty&subcategory=appliances", isCategory: true },
      { name: "Hair Straightener", href: "/products?category=beauty&subcategory=hair-straightener" },
      { name: "Hair Dryer", href: "/products?category=beauty&subcategory=hair-dryer" },
      { name: "Epilator", href: "/products?category=beauty&subcategory=epilator" },
      { name: "Men's Grooming", href: "/products?category=beauty&subcategory=mens-grooming", isCategory: true },
      { name: "Trimmers", href: "/products?category=beauty&subcategory=trimmers" },
      { name: "Beard Oil", href: "/products?category=beauty&subcategory=beard-oil" },
      { name: "Hair Wax", href: "/products?category=beauty&subcategory=hair-wax" },
      { name: "Beauty Gift & Makeup Set", href: "/products?category=beauty&subcategory=gift-sets", isCategory: true },
      { name: "Beauty Gift", href: "/products?category=beauty&subcategory=beauty-gifts" },
      { name: "Makeup Kit", href: "/products?category=beauty&subcategory=makeup-kit" },
      { name: "Premium Beauty", href: "/products?category=beauty&subcategory=premium-beauty" },
      { name: "Wellness & Hygiene", href: "/products?category=beauty&subcategory=wellness" },
    ]
  },
  { 
    name: "GenZ", 
    ...
    submenu: [
      { name: "Women's Western Wear", href: "/products?category=genz&subcategory=womens-western", isCategory: true },
      { name: "Dresses Under ₹599", href: "/products?category=genz&subcategory=dresses-599" },
      { name: "Tops Under ₹399", href: "/products?category=genz&subcategory=tops-399" },
      { name: "Jeans Under ₹599", href: "/products?category=genz&subcategory=jeans-599" },
      { name: "Trousers Under ₹699", href: "/products?category=genz&subcategory=trousers-699" },
      { name: "T-shirts Under ₹299", href: "/products?category=genz&subcategory=tshirts-299" },
      { name: "Shirts Under ₹499", href: "/products?category=genz&subcategory=shirts-499" },
      { name: "Skirts Under ₹499", href: "/products?category=genz&subcategory=skirts-499" },
      { name: "Shorts Under ₹699", href: "/products?category=genz&subcategory=shorts-699" },
      { name: "Co-ords Under ₹799", href: "/products?category=genz&subcategory=coords-799" },
      { name: "Jumpsuits Under ₹899", href: "/products?category=genz&subcategory=jumpsuits-899" },
      { name: "Track pants Under ₹699", href: "/products?category=genz&subcategory=trackpants-699" },
      { name: "Jackets Under ₹899", href: "/products?category=genz&subcategory=jackets-899" },
      { name: "Sweatshirts Under ₹699", href: "/products?category=genz&subcategory=sweatshirts-699" },
      { name: "Sweaters Under ₹899", href: "/products?category=genz&subcategory=sweaters-899" },
      { name: "Women's Ethnic Wear", href: "/products?category=genz&subcategory=womens-ethnic", isCategory: true },
      { name: "Kurtas Under ₹399", href: "/products?category=genz&subcategory=kurtas-399" },
      { name: "Kurtis Under ₹499", href: "/products?category=genz&subcategory=kurtis-499" },
      { name: "Kurta sets Under ₹499", href: "/products?category=genz&subcategory=kurta-sets-499" },
      { name: "Ethnic Dresses Under ₹999", href: "/products?category=genz&subcategory=ethnic-dresses-999" },
      { name: "Palazzos Under ₹799", href: "/products?category=genz&subcategory=palazzos-799" },
      { name: "Lingerie & Loungewear", href: "/products?category=genz&subcategory=lingerie", isCategory: true },
      { name: "Bras Under ₹399", href: "/products?category=genz&subcategory=bras-399" },
      { name: "Night suits Under ₹799", href: "/products?category=genz&subcategory=nightsuits-799" },
      { name: "Nightdresses Under ₹999", href: "/products?category=genz&subcategory=nightdresses-999" },
      { name: "Lounge pants Under ₹999", href: "/products?category=genz&subcategory=lounge-pants-999" },
      { name: "Briefs Under ₹599", href: "/products?category=genz&subcategory=briefs-599" },
      { name: "Men's Casual Wear", href: "/products?category=genz&subcategory=mens-casual", isCategory: true },
      { name: "T-shirts Under ₹299", href: "/products?category=genz&subcategory=mens-tshirts-299" },
      { name: "Shirts Under ₹499", href: "/products?category=genz&subcategory=mens-shirts-499" },
      { name: "Jeans Under ₹599", href: "/products?category=genz&subcategory=mens-jeans-599" },
      { name: "Trousers Under ₹699", href: "/products?category=genz&subcategory=mens-trousers-699" },
      { name: "Shorts Under ₹599", href: "/products?category=genz&subcategory=mens-shorts-599" },
      { name: "Track pants Under ₹699", href: "/products?category=genz&subcategory=mens-trackpants-699" },
      { name: "Jackets Under ₹899", href: "/products?category=genz&subcategory=mens-jackets-899" },
      { name: "Sweatshirts Under ₹699", href: "/products?category=genz&subcategory=mens-sweatshirts-699" },
      { name: "Sweaters Under ₹999", href: "/products?category=genz&subcategory=mens-sweaters-999" },
      { name: "Co-ords Under ₹999", href: "/products?category=genz&subcategory=mens-coords-999" },
      { name: "Men's Occasion Wear", href: "/products?category=genz&subcategory=mens-occasion", isCategory: true },
      { name: "Kurtas Under ₹799", href: "/products?category=genz&subcategory=mens-kurtas-799" },
      { name: "Kurta Sets Under ₹999", href: "/products?category=genz&subcategory=mens-kurta-sets-999" },
      { name: "Women's Footwear", href: "/products?category=genz&subcategory=womens-footwear", isCategory: true },
      { name: "Heels Under ₹599", href: "/products?category=genz&subcategory=heels-599" },
      { name: "Flats Under ₹499", href: "/products?category=genz&subcategory=flats-499" },
      { name: "Casual shoes Under ₹699", href: "/products?category=genz&subcategory=womens-casual-shoes-699" },
      { name: "Sports shoes Under ₹999", href: "/products?category=genz&subcategory=womens-sports-shoes-999" },
      { name: "Flip flops Under ₹799", href: "/products?category=genz&subcategory=womens-flipflops-799" },
      { name: "Boots Under ₹999", href: "/products?category=genz&subcategory=womens-boots-999" },
      { name: "Ballerinas Under ₹799", href: "/products?category=genz&subcategory=ballerinas-799" },
      { name: "Men's Footwear", href: "/products?category=genz&subcategory=mens-footwear", isCategory: true },
      { name: "Casual shoes Under ₹799", href: "/products?category=genz&subcategory=mens-casual-shoes-799" },
      { name: "Sports shoes Under ₹999", href: "/products?category=genz&subcategory=mens-sports-shoes-999" },
      { name: "Formal shoes Under ₹999", href: "/products?category=genz&subcategory=formal-shoes-999" },
      { name: "Sandals Under ₹799", href: "/products?category=genz&subcategory=mens-sandals-799" },
      { name: "Flip flops Under ₹499", href: "/products?category=genz&subcategory=mens-flipflops-499" },
      { name: "Boots Under ₹999", href: "/products?category=genz&subcategory=mens-boots-999" },
      { name: "Beauty & Grooming", href: "/products?category=genz&subcategory=beauty-grooming", isCategory: true },
      { name: "Skincare Under ₹299", href: "/products?category=genz&subcategory=skincare-299" },
      { name: "Haircare Under ₹399", href: "/products?category=genz&subcategory=haircare-399" },
      { name: "Bath & Body Under ₹399", href: "/products?category=genz&subcategory=bath-body-399" },
      { name: "MakeUp Under ₹299", href: "/products?category=genz&subcategory=makeup-299" },
      { name: "Fragrances Under ₹399", href: "/products?category=genz&subcategory=fragrances-399" },
      { name: "Appliances Under ₹999", href: "/products?category=genz&subcategory=appliances-999" },
      { name: "Accessories", href: "/products?category=genz&subcategory=accessories", isCategory: true },
      { name: "Jewellery Under ₹299", href: "/products?category=genz&subcategory=jewellery-299" },
      { name: "Handbags Under ₹499", href: "/products?category=genz&subcategory=handbags-499" },
      { name: "Clutches Under ₹999", href: "/products?category=genz&subcategory=clutches-999" },
      { name: "Backpacks Under ₹699", href: "/products?category=genz&subcategory=backpacks-699" },
      { name: "Wallets Under ₹499", href: "/products?category=genz&subcategory=wallets-499" },
      { name: "Sunglasses Under ₹699", href: "/products?category=genz&subcategory=sunglasses-699" },
      { name: "Belts Under ₹799", href: "/products?category=genz&subcategory=belts-799" },
      { name: "Caps Under ₹899", href: "/products?category=genz&subcategory=caps-899" },
    ]
  },
  { 
    name: "Studio", 
            ...
            <div className="hidden lg:flex items-center space-x-8 flex-1">
              {navigation.map((item, index) => (
                <div key={item.name} className="relative group">
                  ...
                  <div className="absolute top-full left-0 mt-2 bg-white dark:bg-gray-800 shadow-xl border-t-4 border-hednor-gold opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 rounded-b-lg"
                       style={{ 
                         width: '70vw', 
                         maxWidth: '800px', 
                         minWidth: '600px'
