              ...
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">Track and manage all customer orders</p>
                  </div>
                  <div className="flex gap-2">
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xl font-bold">₹{orders.reduce((sum, o) => sum + (o.total || 0), 0).toLocaleString()}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      <div className="flex justify-between">
                        ...
                        <span className="font-medium">₹{Math.round(orders.reduce((sum, o) => sum + o.total, 0) / orders.length || 0)}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-sm">Orders Today</span>
                        <span className="font-medium">{orders.filter(o => new Date(o.createdAt).toDateString() === new Date().toDateString()).length}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      {orders.slice(0, 3).map((order, index) => (
                        <div key={order._id} className="flex items-center gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-xs text-gray-500">₹{order.total.toLocaleString()}</div>
                          </div>
                        </div>
                      ))}
                    </CardContent>
              ...
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">Manage customer relationships and insights</p>
                  </div>
                  <div className="flex gap-2">
                    <Button variant="outline">
                      <Upload className="h-4 w-4 mr-2" />
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-2xl font-bold">{users.filter(u => new Date(u.createdAt) > new Date(Date.now() - 30 * 24 * 60 * 60 * 1000)).length}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-2xl font-bold">{users.filter(u => u.totalSpent > 10000).length}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="p-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-xl font-bold">₹{Math.round(users.reduce((sum, u) => sum + u.totalSpent, 0) / users.length || 0).toLocaleString()}</p>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Analyze customer behavior and spending patterns</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-lg">
                        ...
                        <div className="text-2xl font-bold text-purple-700">{users.filter(u => u.totalSpent > 10000).length}</div>
                        <div className="text-sm text-purple-600">Spent >₹10,000</div>
                      </div>
                      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg">
                        ...
                        <div className="text-2xl font-bold text-blue-700">{users.filter(u => u.totalSpent > 2000 && u.totalSpent <= 10000).length}</div>
                        <div className="text-sm text-blue-600">₹2,000 - ₹10,000</div>
                      </div>
                      <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-lg">
                        ...
                        <div className="text-2xl font-bold text-green-700">{users.filter(u => u.totalSpent <= 2000).length}</div>
                        <div className="text-sm text-green-600">First time buyers</div>
                      </div>
                      <div className="bg-gradient-to-r from-orange-50 to-red-50 p-4 rounded-lg">
                        ...
                        <div className="text-2xl font-bold text-orange-700">{Math.floor(users.length * 0.15)}</div>
                        <div className="text-sm text-orange-600">No orders in 90 days</div>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      <AreaChart data={[
                        ...
                        <YAxis />
                        <Tooltip />
                        <Area type="monotone" dataKey="customers" stroke="#3B82F6" fill="#DBEAFE" strokeWidth={2} />
                      </AreaChart>
                    </ResponsiveContainer>
                  </CardContent>
                </Card>
                      ...
                      <div className="space-y-4">
                        {users
                          ...
                          <div key={user._id} className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                            ...
                            <div className="flex-1">
                              <div className="font-medium">{user.name}</div>
                              <div className="text-sm text-gray-500">{user.totalOrders} orders</div>
                            </div>
                            <div className="text-right">
                              <div className="font-medium">₹{user.totalSpent.toLocaleString()}</div>
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                          <div>
                            ...
                            <div className="text-sm text-gray-500">Customers who bought again</div>
                          </div>
                          <div className="text-2xl font-bold text-green-600">
                            {Math.round((users.filter(u => u.totalOrders > 1).length / users.length) * 100)}%
                          </div>
                        </div>
                        <div className="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                          <div>
                            <div className="font-medium">Customer Satisfaction</div>
                            <div className="text-sm text-gray-500">Based on reviews & returns</div>
                          </div>
                          <div className="text-2xl font-bold text-blue-600">4.8/5</div>
                        </div>
                        <div className="flex justify-between items-center p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                          <div>
                            <div className="font-medium">Avg Days Between Orders</div>
                            <div className="text-sm text-gray-500">Customer purchase frequency</div>
                          </div>
              ...
              <div className="space-y-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">Deep insights into your business performance</p>
                  </div>
                  <div className="flex gap-2">
                    <Select defaultValue="last30">
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-3xl font-bold text-blue-600">{dashboardStats?.conversionRate || 0}%</p>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-3xl font-bold text-purple-600">₹5,240</p>
                          <p className="text-xs text-green-600 flex items-center mt-1">
                            <TrendingUp className="h-3 w-3 mr-1" />
                            +8.7% from last month
                          </p>
                    ...
                    <CardContent>
                      <ResponsiveContainer width="100%" height={300}>
                        <AreaChart data={salesData}>
                          ...
                          <Tooltip />
                          <Area yAxisId="left" type="monotone" dataKey="revenue" stackId="1" stroke="#F59E0B" fill="#FEF3C7" strokeWidth={2} />
                          <Area yAxisId="right" type="monotone" dataKey="orders" stackId="2" stroke="#3B82F6" fill="#DBEAFE" strokeWidth={2} />
                        </AreaChart>
                      </ResponsiveContainer>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent>
                        ...
                        <PieChart>
                          <Pie
                            data={[
                              ...
                              { name: 'Returning Customers', value: 35, color: '#F59E0B' }
                            ]}
                            cx="50%"
                            cy="50%"
                            innerRadius={60}
                      ...
                      <div className="flex justify-center gap-4 mt-4">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm">New (65%)</span>
                        </div>
                        <div className="flex items-center gap-2">
                          <div className="w-3 h-3 rounded-full bg-amber-500" />
                          <span className="text-sm">Returning (35%)</span>
                        </div>
                      </div>
                    </CardContent>
                  </Card>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <Card>
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {topProducts.map((product, index) => (
                          <div key={product.name} className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    ...
                    <CardContent>
                      <div className="space-y-4">
                        {categories.slice(0, 5).map((category, index) => {
                          ...
                          const categoryRevenue = categoryProducts.reduce((sum, p) => sum + (p.price * 10), 0); // Mock calculation
                          return (
                            <div key={category._id} className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                              ...
                              <div className="text-right">
                                <div className="font-medium">₹{categoryRevenue.toLocaleString()}</div>
                                <div className="text-sm text-gray-500">revenue</div>
                              </div>
                            </div>
                          );
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-4">
                        <h4 className="font-medium">Order Value by Region</h4>
                        <div className="space-y-3">
                          {[
                            { region: 'North India', value: 45200, orders: 156 },
                            { region: 'South India', value: 38900, orders: 134 },
                            { region: 'West India', value: 52100, orders: 189 },
                            { region: 'East India', value: 28400, orders: 98 }
                          ].map((item) => (
                            <div key={item.region} className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Live website activity and events</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                      ...
                      <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                        <div className="text-2xl font-bold text-green-600">{Math.floor(Math.random() * 10 + 5)}</div>
                        <div className="text-sm text-green-600">Live Orders</div>
                      </div>
                      <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg">
                        <div className="text-2xl font-bold text-purple-600">{Math.floor(Math.random() * 100 + 50)}</div>
                        <div className="text-sm text-purple-600">Page Views/hr</div>
                      </div>
                      <div className="bg-orange-50 dark:bg-orange-900/20 p-4 rounded-lg">
                        <div className="text-2xl font-bold text-orange-600">₹{Math.floor(Math.random() * 5000 + 2000).toLocaleString()}</div>
